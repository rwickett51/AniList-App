...
import {SafeAreaView, Text, StyleSheet, View, ScrollView, Dimensions, Button, Alert, RefreshControl, ActivityIndicator, AsyncStorage} from 'react-native'
    ...
    if(this.state.refreshing) {
      ...
      return(
        <View>
          ...
          <ScrollView style={styles.background} refreshControl={<RefreshControl refreshing={this.state.refreshing} onRefresh={this.RefreshHandler.bind(this)} />}>
            {this.state.data}
          </ScrollView>
        </View>
