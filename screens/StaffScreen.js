...
import StaffHorizontalList from "../components/StaffHorizontalList.js";

//Import Services
import {getStaffInfo} from "../services/AniListQueryService.js";
...
export default class StaffScreen extends React.Component {
  ...
  componentDidMount() {
    getStaffInfo(this.props.navigation.state.params.id).then(data => {
      ...
      return (
        ...
        >
          <ScrollView style={{flex: 1, backgroundColor: "rgba(0,0,0, 0.25)"}}>
            ...
            <StaffHorizontalList data={this.state.data} />
          </ScrollView>
        </ImageBackground>
      );
  }
