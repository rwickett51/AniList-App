...
import ImageLoader from "../components/AutoscaleImageLoader.js";
import CharacterHorizontalList from "../components/CharacterHorizontalList.js";

//Import Custom Styles
import defaultStyles from "../constants/MarkdownStyles.js";

//Import Services
import {getCharacterInfo, toggleLike} from "../services/AniListQueryService.js";
...
export default class CharacterScreen extends React.Component {
  ...
  componentDidMount() {
    this.getData().then(data => {
      ...
      NavigationService.setParams({
        favourites: data.data.Character.favourites
      });
    });
  }
      ...
      return (
        <View style={StyleSheet.absoluteFill}>
          ...
          <TouchableHighlight
            ...
            style={{top: 0, right: 0, position: "absolute", zIndex: 100}}
          >
          ...
          >
            ...
            <View style={styles.ContentContainer}>
              ...
              <CharacterHorizontalList data={this.state.data} />
            </View>
          </ScrollView>
        </View>
      );
